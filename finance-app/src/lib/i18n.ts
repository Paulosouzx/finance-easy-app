...
const dictionaries = {
  pt: {
    ...
    "settings.install.title": "Instalar aplicação",
    "settings.install.subtitle": "Adiciona a app ao ecrã principal — abre em ecrã inteiro, sem barra de navegador.",
  ...
  en: {
    ...
    "settings.install.subtitle": "Add the app to your home screen — opens full screen, no browser bar.",
